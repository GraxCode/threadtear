...
public enum ExecutionTag {
  ...
  POSSIBLY_MALICIOUS("Can possibly run malicious code."), BETTER_DECOMPILE("Improves decompilability."), BETTER_DEOBFUSCATE("Can help other executions."), SHRINK("Shrinks the file size.");
